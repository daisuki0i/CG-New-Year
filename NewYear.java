...
public class NewYear extends JPanel {
        ...
        public void paintComponent(Graphics g) {
                ...
                mainBuffer = floodFill(mainBuffer, new Point(454, 351), MyColor.CHINESE_NEW_YEAR,
                ...
                mainBuffer = floodFill(mainBuffer, new Point(506, 369), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(513, 369), MyColor.CHINESE_NEW_YEAR,
                ...
                mainBuffer = floodFill(mainBuffer, new Point(509, 353), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(513, 353), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(555, 371), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(563, 371), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(559, 351), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(563, 351), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(556, 347), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(455, 338), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(455, 324), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(455, 319), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(455, 379), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(455, 383), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(405, 349), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(405, 347), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(405, 334), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(405, 326), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(405, 323), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(412, 348), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(412, 346), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(412, 333), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(412, 325), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(412, 322), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(364, 316), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(364, 349), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(326, 355), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(326, 351), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(326, 337), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(326, 326), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(326, 318), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(326, 311), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(333, 355), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(333, 339), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(333, 318), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(334, 355), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(334, 318), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(267, 351), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(267, 326), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(267, 305), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(273, 305), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);

                // สีรั้วที่โดนตึก 4 ทับ
                mainBuffer = floodFill(mainBuffer, new Point(236, 345), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(236, 314), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(236, 312), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(236, 310), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(236, 305), MyColor.CREAM, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(244, 345), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(244, 314), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(244, 312), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(244, 310), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(244, 305), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(212, 330), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(212, 316), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(212, 314), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(212, 312), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(212, 305), MyColor.CREAM, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(219, 330), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(219, 314), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(219, 312), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(219, 310), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(219, 305), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(187, 333), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(187, 318), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(187, 316), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(187, 314), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(187, 305), MyColor.CREAM, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(194, 333), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(194, 316), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(194, 314), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(194, 312), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(194, 305), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(161, 333), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 320), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 318), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 317), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 315), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 305), MyColor.CREAM, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 299), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(161, 296), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(168, 333), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(168, 320), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(168, 318), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(168, 317), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(168, 315), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(168, 305), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(168, 299), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);

                // สีรั้วที่โดนตึกดำทับ
                mainBuffer = floodFill(mainBuffer, new Point(136, 317), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(144, 317), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(112, 341), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(112, 336), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(112, 328), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(112, 316), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(112, 306), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(112, 296), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(110, 294), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(119, 341), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(119, 335), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(119, 323), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(119, 315), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(119, 304), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(119, 295), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(86, 340), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(86, 337), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(86, 329), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(86, 317), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(86, 307), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(86, 297), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(86, 295), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(94, 340), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(94, 337), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(94, 329), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(94, 317), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(94, 307), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(94, 297), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(94, 295), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(67, 340), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(67, 338), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(67, 328), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(67, 318), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(67, 309), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(67, 298), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(67, 295), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(73, 340), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(73, 338), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(73, 328), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(73, 318), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(73, 309), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(73, 298), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(73, 295), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(47, 328), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(52, 328), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(25, 317), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(28, 317), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(33, 317), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(5, 316), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(14, 316), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(587, 346), MyColor.ANTARCTIC_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(442, 316), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(439, 316), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(433, 315), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(428, 314), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(424, 314), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(419, 314), MyColor.CREAM, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(403, 311), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(399, 310), MyColor.CHINESE_NEW_YEAR,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(396, 310), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(391, 309), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(386, 308), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(383, 308), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(380, 308), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(291, 298), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(288, 298), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(266, 296), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(249, 294), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(242, 294), MyColor.CREAM, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(221, 292), MyColor.VIOLET_INDIGO, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(216, 292), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(148, 288), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(111, 286), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(53, 284), MyColor.BACKGROUND_GRADIENT_COLOR[6],
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(48, 284), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(465, 325), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(471, 326), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(506, 332), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(541, 339), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(572, 346), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(574, 347), MyColor.SUPERIOR_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(579, 348), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(442, 316 + 3), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(439, 316 + 3), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(433, 315 + 3), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(428, 314 + 3), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(424, 314 + 3), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(419, 314 + 3), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(403, 311 + 3), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(399, 310 + 3), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(396, 310 + 3), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(391, 309 + 3), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(386, 308 + 3), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(383, 308 + 3), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(380, 308 + 3), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(291, 298 + 3), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(288, 298 + 3), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(266, 296 + 3), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(249, 294 + 3), MyColor.VIOLET_INDIGO,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(242, 294 + 3), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(216, 292 + 3), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(201, 294), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(201, 296), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(191, 295), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(148, 288 + 3), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(111, 286 + 5), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(48, 284 + 5), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(555, 396), MyColor.BACKGROUND_GRADIENT_COLOR[6],
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(478, 382), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(427, 374), MyColor.BACKGROUND_GRADIENT_COLOR[6],
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(449, 378), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(439, 374), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(423, 371), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(413, 372), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(407, 371), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(406, 369), MyColor.CREAM, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(399, 368), MyColor.CHINESE_NEW_YEAR,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(396, 368), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(391, 368), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(386, 367), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(383, 367), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(374, 365), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(342, 361), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(335, 360), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(333, 360), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(318, 359), MyColor.VIOLET_INDIGO, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(316, 359), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(308, 358), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(293, 356), MyColor.POST_BLUE, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(291, 356), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(284, 355), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(266, 354), MyColor.PRINCE_CHARMING,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(245, 352), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(220, 350), MyColor.AMOR, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(139, 345), MyColor.PASSIONATE_BLUE,
                                MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(112, 344), MyColor.LIMOGES, MyColor.ANTARCTIC_BLUE);
                mainBuffer = floodFill(mainBuffer, new Point(37, 341), MyColor.PASSIONATE_BLUE, MyColor.ANTARCTIC_BLUE);

                mainBuffer = floodFill(mainBuffer, new Point(5, 346), MyColor.BACKGROUND_GRADIENT_COLOR[6],
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(591, 411), MyColor.ANTARCTIC_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(439, 374 + 5), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(423, 371 + 5), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(407, 371 + 3), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(391, 368 + 5), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(386, 367 + 5), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(383, 367 + 5), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(374, 365 + 5), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(342, 361 + 5), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(335, 360 + 5), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(333, 360 + 5), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(318, 359 + 5), MyColor.VIOLET_INDIGO,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(308, 358 + 5), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(293, 356 + 5), MyColor.POST_BLUE, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(291, 356 + 5), MyColor.ROSE_TURKISH_DELIGHT,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(266, 354 + 5), MyColor.PRINCE_CHARMING,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(245, 352 + 5), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(220, 350 + 5), MyColor.AMOR, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(139, 345 + 5), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(112, 344 + 5), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(37, 341 + 5), MyColor.PASSIONATE_BLUE,
                                MyColor.SASQUATCH_SOCKS);
                mainBuffer = floodFill(mainBuffer, new Point(24, 345), MyColor.LIMOGES, MyColor.SASQUATCH_SOCKS);
                ...
                plotDebug(g, new Point(288,354), 1);
        }
        ...
        private BufferedImage drawRoad(Graphics g, BufferedImage mainBuffer) {
                ...
                mainBuffer = floodFill(mainBuffer, new Point(137, 365), MyColor.PASSIONATE_BLUE,
                                MyColor.ALASKAN_CRUISE);
                mainBuffer = floodFill(mainBuffer, new Point(37, 362), MyColor.PASSIONATE_BLUE, MyColor.ALASKAN_CRUISE);
        ...
        private BufferedImage drawCar(Graphics g, BufferedImage mainBuffer) {
                ...
                // body
                drawLine(g, new Point(175, 452), new Point(335, 508), MyColor.ANTARCTIC_BLUE); // เส้นตรง1
                                                                                               // ก่อนถึงล้อหลัง
                drawLine(g, new Point(175, 467), new Point(335, 522), MyColor.ANTARCTIC_BLUE); // เส้นตรง2
                                                                                               // ก่อนถึงล้อหลัง
                ...
                drawArc(g, new Point(505, 500), new Point(508, 490), new Point(508, 485), new Point(514, 517),
                                MyColor.ANTARCTIC_BLUE); // เส้นโค้งของเส้นที่
                // 1กับ2
                // เชื่อมกันตรงท้ายรถ
                drawArc(g, new Point(500, 535), new Point(520, 525), new Point(515, 515), new Point(510, 515),
                                MyColor.DAZZLED_BLUE); // เส้นโค้งของเส้นที่
                // 2กับ3
                // เชื่อมกันตรงท้ายรถ
                ...
                drawArc(g, new Point(285, 528), new Point(283, 538), new Point(280, 558), new Point(290, 568),
                                MyColor.REAL_SHADOW);
                drawArc(g, new Point(290, 568), new Point(295, 583), new Point(315, 565), new Point(315, 550),
                                MyColor.REAL_SHADOW);
                // drawArc(g, new Point(317, 550), new Point(320, 540), new Point(319, 515), new
                // Point(314, 516), MyColor.REAL_SHADOW);
                // drawArc(g, new Point(314, 516), new Point(305, 511), new Point(300, 510), new
                // Point(285, 528), MyColor.REAL_SHADOW);
                drawArc(g, new Point(283, 532), new Point(289, 490), new Point(310, 520), new Point(315, 550), 1,
                                MyColor.REAL_SHADOW);

                // car structure
                drawLine(g, new Point(132, 450), new Point(132, 420), MyColor.LINE_CAR);
                drawArc(g, new Point(132, 420), new Point(135, 410), new Point(143, 405), new Point(160, 400), 1,
                                MyColor.LINE_CAR);
                drawLine(g, new Point(160, 400), new Point(200, 380), MyColor.LINE_CAR);
                drawArc(g, new Point(200, 380), new Point(210, 375), new Point(220, 370), new Point(240, 370), 1,
                                MyColor.LINE_CAR);
                drawLine(g, new Point(240, 370), new Point(310, 380), MyColor.LINE_CAR);
                ...
                drawArc(g, new Point(355, 450), new Point(360, 460), new Point(360, 470), new Point(360, 512), 1,
                                MyColor.LINE_CAR);
                drawLine(g, new Point(215, 372), new Point(290, 352), MyColor.LINE_CAR);
                drawArc(g, new Point(290, 352), new Point(300, 350), new Point(310, 350), new Point(313, 350), 1,
                                MyColor.LINE_CAR);
                drawLine(g, new Point(313, 350), new Point(445, 370), MyColor.LINE_CAR);
                ...
                drawArc(g, new Point(505, 450), new Point(510, 460), new Point(510, 470), new Point(510, 495), 1,
                                MyColor.LINE_CAR);
                drawLine(g, new Point(310, 380), new Point(452, 375), MyColor.LINE_CAR);
                ...
                drawArc(g, new Point(360, 500), new Point(356, 504), new Point(354, 505), new Point(350, 505), 1,
                                MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(133, 434), new Point(136, 435), MyColor.ANTARCTIC_BLUE);

                drawLine(g, new Point(325, 495), new Point(325, 480), MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(325, 480), new Point(346, 486), MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(346, 486), new Point(346, 503), MyColor.ANTARCTIC_BLUE);

                // หน้าต่างขวา
                drawLine(g, new Point(282, 382), new Point(274, 426), MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(282, 382), new Point(309, 387), MyColor.ANTARCTIC_BLUE);
                drawArc(g, new Point(309, 387), new Point(312, 388), new Point(315, 390), new Point(320, 394), 1,
                                MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(320, 394), new Point(341, 433), MyColor.ANTARCTIC_BLUE);
                drawArc(g, new Point(341, 433), new Point(347, 443), new Point(345, 446), new Point(337, 443), 1,
                                MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(274, 426), new Point(337, 443), MyColor.ANTARCTIC_BLUE);
                drawArc(g, new Point(274, 426), new Point(269, 436), new Point(265, 462), new Point(266, 477), 1,
                                MyColor.ANTARCTIC_BLUE);

                // หน้าต่างซ้าย
                drawLine(g, new Point(274, 381), new Point(266, 424), MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(274, 381), new Point(240, 376), MyColor.ANTARCTIC_BLUE);
                drawArc(g, new Point(240, 376), new Point(235, 375), new Point(230, 375), new Point(215, 382), 1,
                                MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(215, 382), new Point(192, 398), MyColor.ANTARCTIC_BLUE);
                drawArc(g, new Point(192, 398), new Point(187, 402), new Point(182, 403), new Point(194, 406), 1,
                                MyColor.ANTARCTIC_BLUE);
                drawLine(g, new Point(266, 424), new Point(194, 406), MyColor.ANTARCTIC_BLUE);
                drawArc(g, new Point(185, 403), new Point(181, 412), new Point(177, 434), new Point(178, 447), 1,
                                MyColor.ANTARCTIC_BLUE);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(386, 486), MyColor.ALASKAN_CRUISE,
                                MyColor.CHINESE_NEW_YEAR);
                mainBuffer = floodFill(mainBuffer, new Point(479, 479), MyColor.ALASKAN_CRUISE,
                                MyColor.CHINESE_NEW_YEAR);
                ...
                mainBuffer = floodFill(mainBuffer, new Point(310, 377), MyColor.ALASKAN_CRUISE, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(309, 367), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(309, 363), MyColor.SASQUATCH_SOCKS, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(296, 360), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(309, 361), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(284, 359), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(315, 362), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(338, 364), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(346, 365), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(353, 366), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(363, 367), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(370, 368), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(376, 369), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(382, 370), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(392, 371), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(400, 372), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(407, 373), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(414, 374), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(419, 375), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(435, 377), MyColor.FRIJID_PINK, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(441, 378), MyColor.FRIJID_PINK, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(447, 379), MyColor.FRIJID_PINK, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(453, 380), MyColor.FRIJID_PINK, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(459, 381), MyColor.FRIJID_PINK, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(461, 382), MyColor.FRIJID_PINK, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(366, 365), MyColor.ORANGE, MyColor.LIGHT_PINK);
                mainBuffer = floodFill(mainBuffer, new Point(428, 373), MyColor.ANTARCTIC_BLUE, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(453, 377), MyColor.ANTARCTIC_BLUE, MyColor.LIGHT_PINK); // **

                mainBuffer = floodFill(mainBuffer, new Point(296, 353), MyColor.SASQUATCH_SOCKS, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(310, 354), MyColor.LIMOGES, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(344, 358), MyColor.LIMOGES, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(372, 362), MyColor.PRINCE_CHARMING, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(391, 364), MyColor.PRINCE_CHARMING, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(426, 369), MyColor.PRINCE_CHARMING, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(438, 371), MyColor.PRINCE_CHARMING, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(433, 369), MyColor.AMOR, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(423, 368), MyColor.POST_BLUE, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(405, 366), MyColor.SASQUATCH_SOCKS, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(357, 360), MyColor.SASQUATCH_SOCKS, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(325, 357), MyColor.SASQUATCH_SOCKS, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(396, 366), MyColor.POST_BLUE, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(386, 364), MyColor.POST_BLUE, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(383, 363), MyColor.ROSE_TURKISH_DELIGHT, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(398, 365), MyColor.CHINESE_NEW_YEAR, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(410, 368), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(400, 367), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(360, 361), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(350, 360), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(330, 358), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(321, 356), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(300, 354), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(290, 354), MyColor.FRIJID_PINK, MyColor.CREAM);
                mainBuffer = floodFill(mainBuffer, new Point(318, 356), MyColor.VIOLET_INDIGO , MyColor.CREAM);
